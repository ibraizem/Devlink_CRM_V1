...
DROP INDEX IF EXISTS idx_lead_actions_lead_id;
DROP INDEX IF EXISTS idx_lead_actions_agent_id;
DROP INDEX IF EXISTS idx_lead_actions_timestamp;
DROP INDEX IF EXISTS idx_lead_actions_type;

-- Supprimer le trigger existant
DROP TRIGGER IF EXISTS update_lead_actions_updated_at ON lead_actions;

-- Recréer les index pour améliorer les performances
...
-- Recréer le trigger pour mettre à jour updated_at
